...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Daniel\PycharmProjects\python-crud-prod\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Daniel\PycharmProjects\python-crud-prod\venv\Scripts\deactivate.nu'
